...
public class CameraActivity extends AppCompatActivity {
    ...
    public static final String KEY_ENABLE_ALBUM = "enbaleAlbum";
    public static final String KEY_ENABLE_FRONT = "enbaleFront";
    ...
    private Boolean enbaleAlbum = true;
    private Boolean enbaleFront = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        albumButton.setOnClickListener(albumButtonOnClickListener);
        ...
        switchButton.setOnClickListener(switchButtonOnClickListener);
    ...
    private void initParams() {
        ...
        if (getIntent().hasExtra(KEY_ENABLE_ALBUM)) {
            enbaleAlbum = getIntent().getBooleanExtra(KEY_ENABLE_ALBUM, true);
        }
        if (enbaleAlbum) {
        ...
        if (getIntent().hasExtra(KEY_ENABLE_FRONT)) {
            enbaleFront = getIntent().getBooleanExtra(KEY_ENABLE_FRONT, true);
        }
        if (enbaleFront) {
    ...
    private View.OnClickListener switchButtonOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            ...
            cameraView.getCameraControl().switchCamera(cameraId);
        }
    };
